            ...
            if (product) {
                html += `
                    <tr class="line-item-container" data-variant-id="${
                        ...
                        <td class="image">
                            <div style="padding-left: 20px;" class="product_image">
                                <a href="/products/${product.productName}">
                                    <img width="100px" height="160px" src="${
                                        product.image
                        ...
                        <button type="button" class="btn btn-dark" onclick="removeItemFromCart('${localStorage.getItem(
                            "user"
                        )}', ${
                    item.productID
                }); location.reload();"> Xóa </button>
                            <br><br><br>
