                ...
                html += `
                    <div class="row hienthisp">
                        <div class="col-sm-3 col-md-4">
                            <img style="border: 1px solid black; border-radius: 10px;" width="60px" src="${product.image}" alt="">
                            <sup><label style="font-size: 30px;" for="">${item.amount}</label></sup>
                        </div>
                        ...
                        <div class="col-sm-9 col-md-4">
                            <p>${(product.price * item.amount).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</p>
                        </div>
                    </div>
                `;
            }
...
document.getElementById("bill-value").innerHTML = getCartValue(localStorage.getItem("user"));
document.getElementById("sum-value").innerHTML = getCartValue(localStorage.getItem("user")) + 35000;
